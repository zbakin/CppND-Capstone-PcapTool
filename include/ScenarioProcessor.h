...
public:
    ScenarioProcessor(const std::string& filename) : m_Filename(filename), m_Parser(nullptr), m_PcapReader(nullptr) {
    ...
    void displayPacketInfo(const pcpp::Packet& packet, int packetNum);
